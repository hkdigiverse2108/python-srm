...
const ACTIONS = [
    { key: 'issue_create_roles', name: 'Create Issues', sub: 'Raise new project issues' },
    { key: 'issue_manage_roles', name: 'Manage Issues', sub: 'View and edit all issues' },
    { key: 'invoice_creator_roles', name: 'Generate Invoice', sub: 'Create and generate new invoices' },
    { key: 'invoice_verifier_roles', name: 'Approve Invoice', sub: 'Review and approve pending invoices before sending' },
    { key: 'invoice_sender_roles', name: 'Send Invoice to Client', sub: 'Send approved invoice to client via WhatsApp' },
    { key: 'leave_apply_roles', name: 'Apply for Leave', sub: 'Submit personal leave requests' },
    { key: 'leave_manage_roles', name: 'Manage Leaves', sub: 'Approve or reject team leave requests' },
    { key: 'salary_manage_roles', name: 'Manage Salary', sub: 'View and process employee salaries' },
    { key: 'incentive_manage_roles', name: 'Manage Incentives', sub: 'Configure and manage incentive slabs' },
    { key: 'employee_manage_roles', name: 'Manage Employees', sub: 'Add, edit and remove employee records' }
];
